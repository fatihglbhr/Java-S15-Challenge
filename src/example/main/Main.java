...
public class Main {
    public static void main(String[] args) {
        ...
        MemberRecord member1 = new FacultyMember(1L,"FacultyMember 1", "Istanbul","5060550505");
        MemberRecord member2 = new FacultyMember(2L,"FacultyMember 2", "Ankara","5060550505");
        MemberRecord member3 = new Student(3L,"Student 1", "Istanbul","5060550505");
        MemberRecord member4 = new Student(4L,"Student 2", "Ankara","5060550505");
        ...
        new Book(1L,author1,"Poor Folk",2.3, BookStatusEnum.AVAILABLE,"22", BookTypesEnum.STUDY_BOOKS);
